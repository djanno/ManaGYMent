...
public class TableEmployeesController extends AbstractTableMemberController {
    ...
    // volendo il campo model si potrebbe usare nelle classi figlie,cosi come
    // userLogged
     ...
     *            the view
     */
    public TableEmployeesController(final IGym gym, final PrimaryFrame frame, final TableMemberPanel view) {
    ...
    public void handlePaymentCmd(final int index) {
        ...
        final int n = JOptionPane.showConfirmDialog(this.frame, "Vuoi confermare il pagamento del salario di " + employeeToPay.getName() + " "
                + employeeToPay.getSurname() + "?", "Conferma", JOptionPane.OK_CANCEL_OPTION);
