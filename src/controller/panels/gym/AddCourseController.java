...
public class AddCourseController implements IAddCourseController {
     ...
     * @param maxMembers
     *            the number of max member to be checked
     * @throws IllegalArgumentException
     *             if the fields are empty, if name is already existing or if
     *             color is already associated to a course
     * @throws NumberFormatException
     *             if there are conversion errors
     */
