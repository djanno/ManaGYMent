...
public interface ISetCalendarController {
     ...
     * 
     * @throws NoCourseWithCoachesException
     *             if there is't any course that have at least one coach
     */
     ...
     * @return the coaches' list for the course specified in parameter
     *         courseName
     */
     ...
     *            the closing time
     */
    void addPairInHoursCmd(final String courseName, final String employee, final Integer hourFrom, final Integer hourTo, final Integer openingTime,
