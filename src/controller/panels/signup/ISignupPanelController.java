...
public interface ISignupPanelController {
     ...
     * 
     * @param mapToPass
     *            a strategy map containing the credentials provided in input.
     *            Each credential is mapped to a respective enumerator value,
     *            used to verify if the input is allowed.
     */
