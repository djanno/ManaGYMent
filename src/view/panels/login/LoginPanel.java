...
public class LoginPanel extends Background implements ILoginPanel, ActionListener, KeyListener {
	...
	public LoginPanel(final String path) {
		...
		this.add(this.pswLabel, new GridBagConstraints(0, 2, 1, 1, 0, 0.25, GridBagConstraints.PAGE_START, GridBagConstraints.NONE, emptyInsets, 0, 0));	
		this.add(this.pswField, new GridBagConstraints(1, 2, 1, 1, 0, 0.25, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.NONE, emptyInsets, 0, 0));	
		this.add(this.loginButton, new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.LAST_LINE_END, GridBagConstraints.NONE, emptyInsets, 0, 10));	
		this.add(this.signupButton, new GridBagConstraints(1, 2, 1, 1, 0, 0, GridBagConstraints.LAST_LINE_END, GridBagConstraints.NONE, emptyInsets, 0, 10));	
