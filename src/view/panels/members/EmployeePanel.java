...
public class EmployeePanel extends JPanel implements ActionListener, IEmployeePanel{
	...
	public EmployeePanel (){		
		...
		this.employeePanel.add(this.salaryLbl, new GridBagConstraints(0, 0, 1, 1, 0.22, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 4, 0, 0), 0, 0));
		this.employeePanel.add(this.salaryField, new GridBagConstraints(1, 0, 2, 1, 0.78, 0.25, GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL, new Insets(0,	48, 0, 0), 0, 0));
		this.employeePanel.add(this.btnSave, new GridBagConstraints(1, 1, 1, 1, 0.30, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 48, 0, 0), 0, 0));
