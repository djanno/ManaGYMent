...
public class SubscriberPanel extends JPanel implements ActionListener, ISubscriberPanel {
    ...
    public SubscriberPanel() {
        ...
        this.subPanel.add(this.dataILbl, new GridBagConstraints(0, 0, 1, 1, 0.35, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 4, 0, 0), 0, 0));
        this.subPanel.add(this.calSubscription, new GridBagConstraints(1, 0, 2, 1, 0.30, 0.25, GridBagConstraints.LINE_START,
                GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
        this.subPanel.add(this.dataSLbl, new GridBagConstraints(0, 1, 1, 1, 0.35, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 4, 0, 0), 0, 0));
        this.subPanel.add(this.calExpiration, new GridBagConstraints(1, 1, 2, 1, 0.30, 0.25, GridBagConstraints.LINE_START,
                GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
        this.subPanel.add(this.coursesLbl, new GridBagConstraints(0, 2, 1, 1, 0.35, 0.25, GridBagConstraints.LINE_START,
                GridBagConstraints.HORIZONTAL, new Insets(0, 4, 0, 0), 0, 0));
        this.subPanel.add(this.coursesCmb, new GridBagConstraints(1, 2, 1, 1, 0.30, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 10, 0, 0), 0, 0));
        this.subPanel.add(this.btnAdd, new GridBagConstraints(2, 2, 1, 1, 0.30, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 8, 0, 0), 0, 0));
        this.subPanel.add(this.lblRegistered, new GridBagConstraints(0, 3, 1, 1, 0.35, 0.25, GridBagConstraints.CENTER,
                GridBagConstraints.HORIZONTAL, new Insets(0, 4, 0, 0), 0, 0));
        this.subPanel.add(this.registeredscr, new GridBagConstraints(1, 3, 1, 1, 0.30, 0.25, GridBagConstraints.CENTER,
                GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
        this.subPanel.add(this.btnRemove, new GridBagConstraints(2, 3, 1, 1, 0.30, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 10, 0, 0), 0, 0));
        this.subPanel.add(this.btnSave, new GridBagConstraints(1, 4, 1, 1, 0.30, 0.25, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 10, 0, 0), 0, 0));
    ...
    public void setComboBox(final List<ICourse> list) {
        this.coursesCmb.setModel(new DefaultComboBoxModel<String>(UtilityClass.createComboBoxValues(list, course -> course.getCourseName())));
    }
}
