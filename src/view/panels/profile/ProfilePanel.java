...
public class ProfilePanel extends Background implements IProfilePanel, ActionListener {
    ...
    public ProfilePanel(final String path, final String userLogged) {
        ...
        this.centerPanel.add(this.header, new GridBagConstraints(0, 0, 4, 1, 0.5, 0.2, GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        this.centerPanel.add(this.userLoggedLbl, new GridBagConstraints(0, 0, 4, 1, 0.35, 0.2, GridBagConstraints.SOUTH, GridBagConstraints.NONE,
                emptyInsets, 0, 0));
        this.centerPanel.add(this.pswLbl, new GridBagConstraints(0, 1, 1, 1, 0.17, 0.2, GridBagConstraints.LINE_END, GridBagConstraints.NONE,
                emptyInsets, 0, 0));
        this.centerPanel.add(this.pswField, new GridBagConstraints(1, 1, 1, 1, 0.33, 0.2, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
                emptyInsets, 0, 0));
        this.centerPanel.add(this.confirmPswLbl, new GridBagConstraints(0, 2, 1, 1, 0.17, 0.2, GridBagConstraints.LINE_END, GridBagConstraints.NONE,
                emptyInsets, 0, 0));
        this.centerPanel.add(this.confirmPswField, new GridBagConstraints(1, 2, 1, 1, 0.33, 0.2, GridBagConstraints.LINE_START,
                GridBagConstraints.NONE, emptyInsets, 0, 0));
        this.centerPanel.add(this.changePswButton, new GridBagConstraints(1, 3, 1, 1, 0.33, 0.2, GridBagConstraints.LINE_START,
                GridBagConstraints.NONE, emptyInsets, 0, 0));
        this.centerPanel.add(this.emailLbl, new GridBagConstraints(2, 1, 1, 1, 0.17, 0.2, GridBagConstraints.LINE_END, GridBagConstraints.NONE,
                emptyInsets, 0, 0));
        this.centerPanel.add(this.emailField, new GridBagConstraints(3, 1, 1, 1, 0.33, 0.2, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
                emptyInsets, 0, 0));
        this.centerPanel.add(this.confirmEmailLbl, new GridBagConstraints(2, 2, 1, 1, 0.17, 0.2, GridBagConstraints.LINE_END,
                GridBagConstraints.NONE, emptyInsets, 0, 0));
        this.centerPanel.add(this.confirmEmailField, new GridBagConstraints(3, 2, 1, 1, 0.33, 0.2, GridBagConstraints.LINE_START,
                GridBagConstraints.NONE, emptyInsets, 0, 0));
        this.centerPanel.add(this.changeEmailButton, new GridBagConstraints(3, 3, 1, 1, 0.33, 0.2, GridBagConstraints.LINE_START,
                GridBagConstraints.NONE, emptyInsets, 0, 0));
