...
public class SendEmailPanel extends Background implements ActionListener, ISendEmailPanel {
    ...
    public SendEmailPanel(final String path) {
        ...
        final GridBagConstraints gbcTextFObject = new GridBagConstraints(0, 0, 1, 1, 1, 0.1, GridBagConstraints.CENTER,
                GridBagConstraints.HORIZONTAL, insetsG, 1, 1);
        pCenter.add(txtObject, gbcTextFObject);

        final GridBagConstraints gbcMessage = new GridBagConstraints(0, 1, 1, 1, 1, 0.9, GridBagConstraints.CENTER, GridBagConstraints.BOTH, insets,
                1, 1);
        pCenter.add(scroll, gbcMessage);

        final JLabel lblSendTo = new JLabel("Invia a:");
        final GridBagConstraints gbcSendToLbl = new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
                insets, 1, 1);
        pEast.add(lblSendTo, gbcSendToLbl);

        final JLabel lblEmployee = new JLabel("Impegati:");
        final GridBagConstraints gbcEmployeeLbl = new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
                insets, 1, 1);
        pEast.add(lblEmployee, gbcEmployeeLbl);

        final JLabel lblCurrSubscriver = new JLabel("Iscritti correnti:");
        final GridBagConstraints gbcCurrSubscriverLbl = new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.NONE, insets, 1, 1);
        pEast.add(lblCurrSubscriver, gbcCurrSubscriverLbl);

        final JLabel lblPastSubscriver = new JLabel("Iscritti passati:");
        final GridBagConstraints gbcPastSubscriverLbl = new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.NONE, insets, 1, 1);
        pEast.add(lblPastSubscriver, gbcPastSubscriverLbl);

        final GridBagConstraints gbcEmployeeCheck = new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
                insets, 1, 1);
        pEast.add(chkEmployee, gbcEmployeeCheck);

        final GridBagConstraints gbcCurrSubscriverCheck = new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.NONE, insets, 1, 1);
        pEast.add(chkSubscriber, gbcCurrSubscriverCheck);

        final GridBagConstraints gbcPastSubscriverCheck = new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.NONE, insets, 1, 1);
        pEast.add(chkExSubsriber, gbcPastSubscriverCheck);

        final GridBagConstraints gbcSendButton = new GridBagConstraints(0, 4, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
                insets, 1, 1);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source.equals(this.btnSend)) {
            ...
            if (pass != null) {
                this.observer.cmdSend(txtObject.getText(), txtMessage.getText(), chkEmployee.isSelected(), chkSubscriber.isSelected(),
                        chkExSubsriber.isSelected(), pass);
            }
        }
    }
     ...
     * 
     * @return password insert in the OptionPane, if click on "cancel" return
     *         null
     */
    private char[] insertPassword() {
        ...
        final int option = JOptionPane.showOptionDialog(null, panel, "Inserisci password", JOptionPane.NO_OPTION, JOptionPane.PLAIN_MESSAGE, null,
                options, options[0]);
        if (option == 0) {
