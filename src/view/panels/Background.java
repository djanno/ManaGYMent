...
public class Background extends JPanel implements IBackground{
	...
	/**
	 * Constructs the panel using the string provided to the constructor as the path to the image that is going to be set as the background.
	 * @param path the path to the image that is going to be set as the background.
	 */
