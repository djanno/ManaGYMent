...
/**
 * This class display a window for set program and set the combination
 * course-employee for several hours of a specific day
 * 
 * @author simone
 *
 */
public class SetCalendarPanel extends GenericTable implements ISetCalendarPanel {
    ...
    /**
     * Construct a panel that set the program for a specific day
     * 
     * @param path
    ...
    public void loadFields(final DaysOfWeek day, final Schedule schedule, final List<ICourse> gymCourses, final List<IEmployee> gymCoaches) {
        ...
        this.courses.setModel(new DefaultComboBoxModel<String>(UtilityClass.createComboBoxValues(gymCourses,(c-> c.getCourseName()))));
        this.coachesPerCourse.setModel(new DefaultComboBoxModel<String>(UtilityClass.createComboBoxValues(gymCoaches, employee -> employee.alternativeToString())));
    ...
    private void setHandlers() {
        this.add.addActionListener(e -> this.observer.addPairInHoursCmd((String) this.courses.getSelectedItem(),
                (String) this.coachesPerCourse.getSelectedItem(), (Integer) this.courseHourFrom.getValue(), (Integer) this.courseHourTo.getValue(),
                (Integer) this.gymOpenFrom.getValue(), (Integer) this.gymOpenTo.getValue()));
        ...
        this.end.addActionListener(e -> this.observer.endCmd(this.isOpened.isSelected(), (Integer) this.gymOpenFrom.getValue(),
                (Integer) this.gymOpenTo.getValue()));
        this.isOpened.addItemListener(e -> disenableIfNotOpen());
        this.courses.addItemListener(e -> this.coachesPerCourse.setModel(new DefaultComboBoxModel<String>(UtilityClass
                .createComboBoxValues(this.observer.loadCoachesByCourseName((String) this.courses.getSelectedItem()), employee -> employee.alternativeToString()))));
